...
$(function () {
    ...
    _time_type='year';
	 ...
	 $('#sjdasltjGrid').datagrid({    
		    url:'<%=request.getContextPath()%>/archivesBaseInfoTrol/statisticalXbtj?year1='+_t_start+'&year2='+_t_end+'&timeType='+_time_type+'&fileType='+_file_type,
		   	border:true,
			pageSize:10,
...
//获取统计年分、数量
	function statisticalByYear(_t_start,_t_end,_time_type,_file_type) {
		...
		$.ajax({
		type:"POST", 
		url:"/jtrc/archivesBaseInfoTrol/statisticalXbtj",
		async:false,
