...
$("#remark").val(editor.getData());
 ...
 var param=$("#xsbjForm").serializeArray();
 ...
 <div style="display: none;" id="fileQueue"></div>
    ...
    <table class="table3">
     <!--  <tr>
      ...
      <td class="right">
      <input id="educationNum" name="educationNum" type="hidden">
      <input id ="educationNum1" name="educationNum1" class="easyui-textbox" size="100" style="width:615px;"  data-options="required:true,disabled:true" style="height:22px">
      </td>
      </tr> -->
       <tr>
     ...
     <tr>
      ...
      <textarea name="remark1" cols="" rows="10" id="remark1" class="span1-2" style="width:90%;">
		</textarea>
      </td>
      </tr> 
       </table>  
