...
$(function () {
    ...
    _time_type='year';
	 ...
	 $('#sjdasltjGrid').datagrid({    
		    url:'<%=request.getContextPath()%>/archivesBaseInfoTrol/statisticalSjdasltj?year1='+_t_start+'&year2='+_t_end+'&timeType='+_time_type, 
		     border:true,
			pageSize:10,
		    ...
		    columns:[[    
		        ...
		        {field:'num',title:'派遣人数',width : $(this).width() * 0.4,align:'center'}
...
//获取统计年分、数量
	function statisticalByYear(_t_start,_t_end,_time_type) {
		...
		$.ajax({
		type:"POST", 
		url:"/jtrc/archivesBaseInfoTrol/statisticalSjdasltj",
		async:false,
		data:{year1:_t_start,year2:_t_end,timeType:_time_type},
