...
<head>
    <script type="text/javascript">
        $(function(){
            $('#fpGrid').datagrid({
                url: eve.path + '/schoolJobFair/queryJobFairs',
                border:true,
                pageSize:10,
                ...
                buttons:[{
                    ...
                    handler:function(){
                        ...
                        if(result){
                        	...
                        	obj.content = con;
                        	$.ajax({
                        		url: eve.path + '/schoolJobFair/saveJobFair',
                        		context:this,
                        		data : obj,
                        		type:'POST',
		...
		function updatePost(id){
            $('#addPostDialog').dialog({
                    ...
                    handler:function(){
                         ...
                         if(result){
                        	...
                        	var con = editor.getData();
                         	...
                         	obj.content = con;
                         	$.ajax({
                         		url: eve.path + '/schoolJobFair/editJobFair',
                         		context:this,
                         		data : obj,
                         		type:'POST',
                         		success:function(data){
				...
				onLoad:function(){
					$.ajax({
						url : eve.path + '/schoolJobFair/get',
						context: this,
						data:{id : id},
						type : 'post',
						success:function(res){
							...
							editor = CKEDITOR.replace('content');
							editor.setData(jobfair.content);
	    	 ...
	    	 $.messager.confirm('系统提示', '是否删除选中数据?', function(r) {  
	    		 if(r){
	    			 $.ajax({  
	 					type: "POST",  
	 					cache: false,  
	 					url: eve.path + "/schoolJobFair/delJobFair",  
	 					data: "id=" + ids,  
	...
	function invalidPost(id, status){
    	...
    	$.ajax({  
			type: "post",  
			cache: false,  
			url: eve.path+"/schoolJobFair/eidtJobFairStatus",  
			data: param,
			success: function (result) {  
				$.msg('保存成功');
				$('#fpGrid').datagrid('reload');  
...
<div id="cc" class="easyui-layout" data-options="fit:true,border: false">
    ...
    <div data-options="region:'center',title:'校园招聘会管理',border:false" style="">
