...
<script type="text/javascript">
   ...
   //页面表单数据加载
     $.ajax({
                url: basePath+"yggl/getYgMsg?id="+id,
                type: "POST",
                ...
                if(data.flag ==true){
               	    $("#ygckForm").form('load', data.rows);//赋值给表单
	...
	<tr>
      ...
      <td class="right">
      <input class="easyui-textbox"  size="60" data-options="multiline:true,disabled:true"  style="height:52px">
	</td>
	</tr>
