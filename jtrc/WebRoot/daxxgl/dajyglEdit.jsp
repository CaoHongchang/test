...
<body>
    ...
    <div id="aa" class="easyui-accordion" style="height:350px;">   
      ...
      <td class="right">
      <input class="easyui-textbox" id="d_content" name="d_content"   size="20"  style="height:22px">
      </td>
      ...
      <td class="right">
       <input class="easyui-textbox" id="d_uid" name="d_uid"   size="20"   style="height:22px">
      </td>
     <tr>
      <td class="left">被借阅人</td>
      <td class="right">
       <input class="easyui-textbox" id="out_uid" name="out_uid"   size="20"   style="height:22px">
	   </td>
	    <td class="left"></td>
      <td class="right">
      ...
      <td class="right">
      <input class="easyui-datebox" id="d_date" name="d_date"  size="20" data-options="required:true" style="height:22px">
	   </td>
      ...
      <td class="right">
      <input class="easyui-datebox" id="back_date" name="back_date"  size="20"   style="height:22px">
	   </td>
        <td class="left">签收人</td>
      <td class="right">
      <input class="easyui-textbox" id="s_uid" name="s_uid"   size="20"  style="height:22px">
      </td>
      </tr>
      </table>  
      </div>   
