  ...
  <form id="fm"  method="post" enctype="multipart/form-data" >
    <div class="easyui-layout" style="height:500px;width:1000px" data-options="fit:true">
     <div  data-options="region:'north',title:'材料信息'" style="height:250px">    
      <table class="table2">
      <tr>
      <td class="left">处分名称</td>
      <td class="right">
      <input class="easyui-textbox"  name="discipname" id="discipname" size="20"  style="height:22px">
	  </td>
	  <td class="left">处分批准机关</td>
      <td class="right">
      <input class="easyui-textbox" name="pzname" id="pzname"  size="20"  style="height:22px">
      </td>
	  </tr>
	  <tr>
	   <td class="left">处分批准日期</td>
       <td class="right">
            <input class="easyui-datebox" name="zzdate" id="zzdate" size="20" data-options="editable:false" value="" style="height:22px">
      </td>
       <td class="left">处分撤销日期</td>
       <td class="right">
      <input class="easyui-datebox" name="outdate" id="outdate" size="20" data-options="editable:false" value="" style="height:22px">
      </td>
	  </tr>
  <tr>
      <td class="left">处分原因</td>
      <td class="right" colspan="3"> <input class="easyui-textbox"  name="discipinfo" id="discipinfo" size="20" data-options="multiline:true" style="height:60px;width:570px"></td>
      </tr>	  
      </table>
      </div>   
