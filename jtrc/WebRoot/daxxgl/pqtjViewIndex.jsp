...
$(function () {
	...
	$('#export_btn').click( function () {
	 ...
	 $('#pqtjGrid').datagrid({    
		    ...
		    columns:[[    
		        ...
		        {field:'name',title:'时间',width : $(this).width() * 0.4,align:'center'},    
		        {field:'y',title:'派遣人数',width : $(this).width() * 0.4,align:'center'}	  
		    ]]    
		});  
	...
	var _file_type = $('#file_type').combobox("getValue");
	...
	function create_chart() {
		...
		_file_type = $('#file_type').combobox("getValue");
		...
		$.getJSON( "../sjbb/tjbb.json",
				...
				function(data){
					...
					for (var i = 0; i < data.rows.length; i++) {						
						...
						var _name = data.rows[i].year + _month
