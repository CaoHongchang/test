...
$(document).ready(function(){  
   // $.parser.parse();
    ...
    <div id="aa" class="easyui-accordion" style="height:350px;">   
      ...
      <td class="right">
       ...
       <input class="easyui-textbox" id="dNo" name="dNo"  size="20" style="height:22px">
	</td>
      </tr>
      <tr>
      ...
      <tr>
      <td class="left">备注</td>
      <td class="right"> <input class="easyui-textbox" id="remark" name="remark"   size="60" data-options="multiline:true" style="height:60px;"></td>
      </tr>
 ...
 <table class="table3">
      ...
      function down_Fj(url){
       window.location.href=basePath+"gdcl/down_Fj?url="+url;
      }
      </script>
       </td>
      </tr>      
