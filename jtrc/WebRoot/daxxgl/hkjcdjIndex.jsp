...
<script type="text/javascript">
   ...
   $('#hkjcdjGrid').datagrid({    
	...
	var pager = $('#hkjcdjGrid').datagrid('getPager');
	pager.pagination({
...
function khjcdjglFuc(flag){
	var url='';
	if(flag==1){
		url='../daxxgl/hkjcdjglAdd.jsp';
		
	}
	else{
		url='../daxxgl/hkxxglAdd.jsp';
	}
...
<div id="tb">
	...
	<div id="zcpshdTool"  style="background-color:#FFFFFF;">
		<a onclick="khjcdjglFuc(1);" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">户口借出</a>
		<a onclick="khjcdjglFuc(2);" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">户口信息</a>
...
<table id="hkjcdjGrid"></table>  
</div>
<div id="hkjcdjglInfo"></div>
