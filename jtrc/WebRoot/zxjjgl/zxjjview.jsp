...
/* 	//下架图片
   ...
   function selectSubmit(){
		...
		$('#tpglGrid').datagrid('load',{
			...
			url:$('title').textbox(getValue),
			url:$('content').textbox(getValue)
		});
	}
...
<div id="cc" class="easyui-layout" data-options="fit:true,border:false">
    ...
    <div data-options="region:'center',title:'中心简介列表',border:false" style="">
        ...
        <table id="tpglGrid" title="" class="easyui-datagrid"
            ...
            <tr>
                <th data-options="field:'id1',checkbox:true,align:'center'">选择</th>
                 ...
                 <th data-options="field:'name',width:50">目录</th>
