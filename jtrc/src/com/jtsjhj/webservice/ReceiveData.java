...
/**
    ...
    public static class Factory{
        ...
        */
        public static ReceiveData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReceiveData object =
                new ReceiveData();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"receiveData".equals(type)){
                                ...
                                return (ReceiveData)com.jtsjhj.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
