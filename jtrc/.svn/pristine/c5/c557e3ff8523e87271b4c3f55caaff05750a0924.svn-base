...
//有效性
 ...
 <div style="display: none;" id="fileQueue"></div>
    ...
    <table class="table3">
      ...
      <td class="right">
      <select id="registerLevel" id="registerLevel" name="registerLevel"   data-options="valueField:'value',textField:'name',readonly:true,editable:false" class="easyui-combobox"  style="width:615px;">   
      ...
      <td class="right">
      <select  id="learnType" name="learnType"   data-options="valueField:'value',textField:'name',readonly:true,editable:false" class="easyui-combobox"  style="width:615px;">   
      </select>
      </td>
      </tr>
      ...
      <td class="right">
      <select id="status" name="status"   data-options="valueField:'value',textField:'name',readonly:true,editable:false" class="easyui-combobox"  style="width:615px;">   
      </select>
      </td>
      </tr> -->
      ...
      <td class="right" style=""><input id ="educationSchool" name="educationSchool" class="easyui-textbox" size="100" style="width:615px;" data-options="readonly:true" style="height:22px"> </td>
      </tr>
      
      
       <tr>
      <td class="left">报考专业</td>
      <td class="right" style=""><input id ="educationMajor" name="educationMajor" class="easyui-textbox" size="100" style="width:615px;" data-options="readonly:true" style="height:22px"> </td>
      </tr>
      
       <tr>
      <td class="left">开始时间</td>
      <td class="right" style=""><input class="easyui-datebox" id ="startTime" name="startTime" size="100" style="width:615px;" data-options="readonly:true" style="height:22px"></td>
      </tr>
     
       <tr>
      <td class="left">结束时间</td>
      <td class="right" style=""><input class="easyui-datebox" id ="endTime" name="endTime"  size="100" style="width:615px;" data-options="readonly:true" style="height:22px"></td>
      </tr>
