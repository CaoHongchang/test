       ...
       <table  class="table2">
	     <tr>
	       <td class="left">审核状态</td>
	        <td class="right">
		        <select id="checkState" data-options="disabled:true" class="easyui-combobox"  name="checkState" style="width:135px;">   
		 ...
		 <tr>
	       ...
	       <td class="right">
	         <input class="easyui-textbox" data-options="disabled:true" name="checkRemark" id="checkRemark" size="40" data-options="multiline:true"  style="height:52px">
		   </td>
		 </tr>
	   </table>   
      </div>
