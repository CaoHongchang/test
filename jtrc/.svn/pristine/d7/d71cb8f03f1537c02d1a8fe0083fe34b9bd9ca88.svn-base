		...
		<div>
			<table class="table2">
				<tr>
					...
					<td class="right">
						<input id="pno" class="easyui-textbox" size="20" name="pno" readonly="readonly" disabled="disabled"
					...
					<td class="right">
						<input id="ywmcname" class="easyui-textbox" size="20" name="name"
							data-options="required:true" style="height: 22px">
					</td>
				</tr>
				<tr>
				...
				<tr>
                    ...
                    <td class="right" colspan="3"  style="padding-right: 30px">
                        <input class="easyui-textbox" name="remarkAdd" id="remarkAdd" data-options="multiline:true,prompt:'办理说明字数限制1000字'" style="width:90%;height:100px">
                    </td>
                 </tr>
                 <tr>
