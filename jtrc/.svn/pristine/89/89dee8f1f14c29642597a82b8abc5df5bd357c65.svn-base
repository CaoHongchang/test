			...
			<div title="审核信息"
				...
				<table class="table2">
					<tr>
						...
						<td class="right"><input id="audit_status" name="audit_status"
							size="25" class="easyui-textbox" readonly="readonly"
							style="height:22px"></td>
					</tr>
					<tr>
						...
						<td class="right">
							<input class="easyui-textbox" name="audit_opinion" readonly="readonly" id="audit_opinion" size="40" data-options="multiline:true"  style="height:52px">
						</td>
					</tr>
				</table>
			</div>
