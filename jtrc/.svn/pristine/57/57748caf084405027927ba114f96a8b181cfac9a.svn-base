	         ...
	         <table class="table2">
				  ...
				  <tr>
				      ...
				      <td class="right fvalue" colspan="3">
				      	<input type="radio" name="status" class="easyui-validatebox rstaus" data-options="validType:['requireRadio[\'status\']']"  value="1"/>审核通过
				      	<input type="radio" name="status" class="easyui-validatebox rstaus" data-options="validType:['requireRadio[\'status\']']"  value="2"/>审核不通过
				      </td>
				  </tr>
				  <tr>
