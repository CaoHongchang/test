...
$(function () {
    ...
    _file_type="sj";
	 ...
	 $('#pqtjGrid').datagrid({    
		    url:'<%=request.getContextPath()%>/archivesBaseInfoTrol/statisticalLrtj?year1='+_t_start+'&year2='+_t_end+'&timeType='+_time_type+'&fileType='+_file_type,
		    border:true,
			pageSize:10,
	...
	function statisticalByYear(_t_start,_t_end,_time_type,_file_type) {
		...
		$.ajax({
		type:"POST", 
		url:"/jtrc/archivesBaseInfoTrol/statisticalLrtj",
		async:false,
