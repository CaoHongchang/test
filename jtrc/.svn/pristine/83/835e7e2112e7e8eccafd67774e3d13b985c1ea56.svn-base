...
<input type="hidden" name="da_dpno" id="da_dpno"/>
    <div id="aa" class="easyui-accordion" style="height:350px;">   
      ...
      <td class="right">
      <input class="easyui-textbox" id="school_name" size="20"   name="school_name" style="height:22px">
      </td>
      </tr>
      ...
      <tr>
       ...
       <td class="right">     <input class="easyui-datebox" id="in_date" name="in_date" size="20" data-options="showSeconds:false" value="" style="height:22px"></td>
       <td class="left">毕业日期</td>
       <td class="right">     <input class="easyui-datebox" id="graduation_date" name="graduation_date" size="20" data-options="showSeconds:false" value="" style="height:22px"></td>     
      </tr>
   ...
   <!--   <input class="easyui-textbox" id="education" name="education" size="20" data-options="showSeconds:false" value="" style="height:22px"> -->
          ...
          <select class="easyui-combobox" id="education" name="education" style="width:135px;">   
      ...
      <td class="right">
      	<!--<input class="easyui-textbox" id="degree" name="degree" size="20" data-options="showSeconds:false" value="" style="height:22px">-->
      	 <select class="easyui-combobox" id="degree" name="degree" style="width:135px;">   
      ...
      <td class="right">
         <input class="easyui-textbox"  size="20" id="certificate" name="certificate"  style="height:22px"> 
	  </td>
      <td class="left">学习专业</td>
      <td class="right">
  		    <input class="easyui-textbox"  size="20" id="major" name="major"  style="height:22px"> 
       </td>
      </tr>
