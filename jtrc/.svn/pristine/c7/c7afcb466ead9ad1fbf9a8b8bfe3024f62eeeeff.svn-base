...
/*	public static <T> StringBuilder collectionJoin(Collection<T> list, String field, StringBuilder... builder) {
	 ...
	 * add by huangyimin ${date} Nov 5, 2010 
	 * @param orig
	 * @return
	 */
     ...
     * @return String[] 分割后的数组
     */
    public static List<Long> splitStrToList(String str, String delim) {
        if (str == null || delim == null) return new ArrayList<Long>();
	...
	public static void main(String[] args) {
		...
		System.out.println(StringUtil.cramStringWithKeyAtBefore("1", "0", 3));
	}
	/**
	 * @param strs
	 *        待转化字符串
